...
def main() -> None:
    ...
    md = [
        ...
        (
            ...
            "instead of spreading out. Six follow-up fixes were tried (four "
            "embedding choices for `select()`'s `diversify_with` parameter, an "
            "epsilon-greedy random/uncertainty hybrid, and a k-means clustering-based "
            "diversification algorithm in place of the shipped farthest-first one) — "
            "none held up as a general fix across data seeds. Full numbers in "
